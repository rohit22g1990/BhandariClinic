    ...
    <div class="header">
        <div class="header-left">
            <a href="index-2.html" class="logo">
                <img src="{{ asset('AdminAssets/img/logo.png') }}" width="35" height="35" alt=""> <span>Preclinic</span>
            </a>
        ...
        <ul class="nav user-menu float-right">
                        ...
                        <ul class="notification-list">
                            <li class="notification-message">
                                <a href="activities.html">
                                    <div class="media">
											<span class="avatar">
												<img alt="John Doe" src="{{ asset('AdminAssets/img/user.jpg') }}" class="img-fluid">
											</span>
            ...
            <li class="nav-item dropdown has-arrow">
                <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                        <span class="user-img">
							<img class="rounded-circle" src="{{ asset('AdminAssets/img/user.jpg') }}" width="24" alt="Admin">
...
<script src="{{ asset('AdminAssets/js/Chart.bundle.js') }}"></script>
<script src="{{ asset('AdminAssets/js/Chart.bundle.js') }}"></script>
