    ...
    <div class="main_menu" style="background-color:#f8f9f8;">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                ...
                <a class="navbar-brand logo_h" href="{{url('/home')}}"><img src="{{ asset('images/logo.png') }}" alt=""></a>
...
<!-- start footer Area -->
<footer class="footer-area area-padding-top footer-area-custom">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-sm-6 single-footer-widget">
                <h4 class="color-white">Stay In Touch</h4>
                <ul>
            ...
            <div class="col-lg-3 col-sm-6 single-footer-widget">
                <h4 class="color-white">Opening Hours</h4>
                <ul>
                    <li>Mon: 5 PM : 8 PM</li>
                    <li>Tue: 5 PM : 8 PM</li>
                    <li>Wed: 5 PM : 8 PM</li>
